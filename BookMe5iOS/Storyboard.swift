...
struct Storyboards {
    ...
    struct Main: Storyboard {
        ...
        static func instantiateDetailBuisinessViewController() -> DetailBuisinessViewController {
            return self.storyboard.instantiateViewControllerWithIdentifier("DetailBuisinessViewController") as! DetailBuisinessViewController
        }

        static func instantiateMainController() -> UITabBarController {
            return self.storyboard.instantiateViewControllerWithIdentifier("mainController") as! UITabBarController
        }

        static func instantiateLoginController() -> UINavigationController {
            return self.storyboard.instantiateViewControllerWithIdentifier("loginController") as! UINavigationController
        }
    }
}
...
//MARK: - FeedListViewController
extension UIStoryboardSegue {
    func selection() -> FeedListViewController.Segue? {
        if let identifier = self.identifier {
            return FeedListViewController.Segue(rawValue: identifier)
        }
        return nil
    }
}
...
extension FeedListViewController { 
    ...
    enum Segue: String, CustomStringConvertible, SegueProtocol {
        case detailBuisinessSegue = "detailBuisinessSegue"

        var kind: SegueKind? {
            switch (self) {
            case detailBuisinessSegue:
        ...
        var destination: UIViewController.Type? {
            switch (self) {
            case detailBuisinessSegue:
                return DetailBuisinessViewController.self
            }
        }
...
//MARK: - DetailBuisinessViewController
extension DetailBuisinessViewController: IdentifiableProtocol { 
    var storyboardIdentifier: String? { return "DetailBuisinessViewController" }
    static var storyboardIdentifier: String? { return "DetailBuisinessViewController" }
}
